...
def test_moves_movie_from_watchlist_to_empty_watched():
    ...
    movie_to_remove_from_watchlist = janes_data["watchlist"][0]["title"] 
    ...
    # *******************************************************************************************
    watched_movie = updated_data["watched"][0]["title"]

    assert movie_to_remove_from_watchlist == watched_movie
